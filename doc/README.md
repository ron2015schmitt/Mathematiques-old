...
1. [Vector relational operators (`==`,`<`,`>`, etc), logical operators and masks](vrelational.md)
1. [Vector `join` and `rep` functions](vconcatrep.md)
1. [python-like access: negative indices, slices, lists](vslices.md)
