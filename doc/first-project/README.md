...
| ⇦ <br />[Installation](../installation/README.md)  | [User Guide](../README.md)<br />Your First Mathématiques Project<br /><img width=1000/> | ⇨ <br />[Usage Guide: Syntax, Data types, Functions, etc](../usage-guide/README.md)   |
| ------------ | :-------------------------------: | ------------ |
