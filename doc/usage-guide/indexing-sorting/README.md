...
| ⇦ <br />[Linear Algebra](../linear-algebra/README.md)  | [Usage Guide: Syntax, Data Types, Functions, etc](../README.md)<br />Indexing, Masks, and Sorting<br /><img width=1000/> | ⇨ <br />[Calculus](../calculus/README.md)   |
| ------------ | :-------------------------------: | ------------ |
