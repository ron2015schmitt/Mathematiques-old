...
// ----------------------------------------------------------------
// ##COMMENTNAME##
// template function classes for operator '##OP##'
//
...
auto operator##OP##(const TensorR<A,E1,D1,M,R>& x1, const TensorR<B,E2,D2,M,R>& x2) {
...
auto operator##OP##(const TensorR<A,E,D1,M,R>& x1, const D2& x2) {
  typedef typename ##TYPECLASS##<D1,D2>::Type D3;
...
auto operator##OP##(const D1& x1, const TensorR<B,E,D2,M,R>& x2) {
  typedef typename ##TYPECLASS##<D1,D2>::Type D3;
  typedef typename NumberType<E,D3>::ReplaceTypeE E3;   
...
auto operator##OP##(const TensorR<A,E1,D1,M1,R1>& x1, const TensorR<B,E2,D2,M2,R2>& x2) {
  typedef typename ##TYPECLASS##<D1,D2>::Type D3;
...
auto operator##OP##(const TensorR<A,E1,D1,M1,R>& x1, const TensorR<B,D2,D2,M2,R>& x2) {
...
auto operator##OP##(const TensorR<A,D1,D1,M1,R>& x1, const TensorR<B,E2,D2,M2,R>& x2) {
  // NOT SURE WHICH OF THE THREE IS BEST
