...
template <class E1, class E2, class E3, class E4, class D1, class D2, class D3, class D4> class FUNCTOR_approx { 
public:								
  static D4 apply(const D1 d1, const D2 d2, const D3 d3) {
    return mathq::approx(d1, d2, d3);
  }									
  template <class T1=E1, class T2=E2, class T3=E3>
  static typename std::enable_if<!std::is_same<T1,D1>::value&&!std::is_same<T2,D2>::value&&!std::is_same<T3,D3>::value, E4& >::type 
  apply(const E1& e1, const E2& e2, const E3& e3) { 
    E4 *e4 = new E4();							
    *e4 = mathq::approx(e1, e2, e3);
    return *e4;	
  }									
  template <class T1=E1, class T2=E2, class T3=E3>
  static typename std::enable_if<!std::is_same<T1,D1>::value&&!std::is_same<T2,D2>::value&&std::is_same<T3,D3>::value, E4& >::type 
...
auto approx(const TensorR<A,E1,D1,M,R>& x1, const TensorR<B,E2,D2,M,R>& x2, const TensorR<C,E3,D3,M,R>& x3) {
  ...
  return  TER_Ternary<TensorR<A,E1,D1,M,R>,
		     ...
		     TensorR<C,E3,D3,M,R>,
		     E1,E2,E3,E4,D1,D2,D3,D4,M,M,M,M,R,R,R,R,
		     FUNCTOR_approx<E1,E2,E3,E4,D1,D2,D3,D4> >(x1,x2,x3); 
}
...
auto approx(const TensorR<A,E1,D1,M,R>& x1, const TensorR<B,E2,D2,M,R>& x2, const D3& x3) {
  ...
  return  TER_Ternary<TensorR<A,E1,D1,M,R>,
		     ...
		     D3,
		     E1,E2,D3,E4,D1,D2,D3,D4,M,M,0,M,R,R,R,R,
		     FUNCTOR_approx<E1,E2,D3,E4,D1,D2,D3,D4> >(x1,x2,x3); 
}
...
auto approx(const TensorR<A,E1,D1,M,R>& x1, const D2& x2, const TensorR<C,E3,D3,M,R>& x3) {
  ...
  return  TER_Ternary<TensorR<A,E1,D1,M,R>,
		      ...
		      TensorR<C,E3,D3,M,R>,
		      E1,D2,E3,E4,D1,D2,D3,D4,M,0,M,M,R,R,R,R,
		      FUNCTOR_approx<E1,D2,E3,E4,D1,D2,D3,D4> >(x1,x2,x3); 
}
...
auto approx(const TensorR<A,E1,D1,M,R>& x1, const D2& x2, const D3& x3) {
  ...
  return  TER_Ternary<TensorR<A,E1,D1,M,R>,
		     ...
		     D3,
		     E1,D2,D3,E4,D1,D2,D3,D4,M,0,0,M,R,R,R,R,
		     FUNCTOR_approx<E1,D2,D3,E4,D1,D2,D3,D4> >(x1,x2,x3); 
}
...
auto approx(const D1& x1, const TensorR<B,E2,D2,M,R>& x2, const TensorR<C,E3,D3,M,R>& x3) {
  ...
  return  TER_Ternary<D1,
		     ...
		     TensorR<C,E3,D3,M,R>,
		     D1,E2,E3,E4,D1,D2,D3,D4,0,M,M,M,R,R,R,R,
		     FUNCTOR_approx<D1,E2,E3,E4,D1,D2,D3,D4> >(x1,x2,x3); 
}
...
auto approx(const D1& x1, const TensorR<B,E2,D2,M,R>& x2, const D3& x3) {
  ...
  return  TER_Ternary<D1,
		     ...
		     D3,
		      D1,E2,D3,E4,D1,D2,D3,D4,0,M,0,M,R,R,R,R,
		      FUNCTOR_approx<D1,E2,D3,E4,D1,D2,D3,D4> >(x1,x2,x3); 
}
...
auto approx(const D1& x1, const D2& x2, const TensorR<C,E3,D3,M,R>& x3) {
  ...
  return  TER_Ternary<D1,
		     ...
		     TensorR<C,E3,D3,M,R>,
		     D1,D2,E3,E4,D1,D2,D3,D4,0,0,M,M,R,R,R,R,
		     FUNCTOR_approx<D1,D2,E3,E4,D1,D2,D3,D4> >(x1,x2,x3); 
}
}; // namespace mathq 
