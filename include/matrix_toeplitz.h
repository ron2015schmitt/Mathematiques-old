#ifndef MATHQ__MATRIX_TOEPLITZ_H
#define MATHQ__MATRIX_TOEPLITZ_H 1
...
namespace mathq {
  ...
  /********************************************************************
   * MatrixToeplitz<D        -- variable size matrix (valarray)
   *                        D  = type for elements
   * MatrixToeplitz<D,NR>    -- fixed number of rows (valarray)
   *                        NR = number of rows
